    ...
    var body: some View {
            ...
            VStack(spacing:0) {
                ...
                if let product = viewModel.product {
                        ...
                        VStack(alignment:.leading){
                            ...
                            VStack(alignment:.leading) {
                                HStack(alignment:.center){
                                    UniNeueBoldTextView(text: product.getName, fontSize: 26, colorName: "3A494E")
                                    Spacer()
                                }
                    ...
                    Spacer()
//                    ProductDetailsFooterView(viewModel:self.viewModel,product:product,productShopType:product.getShop.getType)
//                        .padding([.leading,.trailing],15)
//                        .padding([.leading,.trailing],15)
                }else {
                    VStack(alignment:.leading){
